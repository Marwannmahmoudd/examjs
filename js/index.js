...
function display(arr){
   ...
   for (let i = 0; i < arr.length; i++) {
    ...
    <div class="meal overflow-hidden position-relative" onclick ="getdetails(${arr[i].idMeal})">
        ...
        <div class="title position-absolute  d-flex align-items-center text-black ">
                        <h3>${arr[i].strMeal}</h3>
                    </div>
                    </div>
    </div>
...
let gr = ''
  ...
  if(z == undefined){
   ...
   document.getElementById('display2').innerHTML = ''
    ...
    <div><h3>Area : ${meal.strArea}</h3></div>
...
function displaycategory2(arr){
   ...
   for (let i = 0; i < arr.length; i++) {
    cartonna+=` <div class="col-md-3 ">
    <div class="meal overflow-hidden position-relative" onclick ="getcategory3('${arr[i].strCategory}')">
        <div class=""><img src="${arr[i].strCategoryThumb}" class ="w-100 rounded"></div>
        <div class="title2 position-absolute  d-flex flex-column align-items-center text-black ">
